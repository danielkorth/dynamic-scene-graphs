...
def setup_blueprint():
    blueprint = rrb.Blueprint(
        rrb.Vertical(
            rrb.Spatial3DView(name="3D", origin="world", line_grid=rrb.archetypes.LineGrid3D(visible=True, spacing=0.1, plane=rr.components.Plane3D(normal=[0,1,0], distance=-1.8))),
            rrb.Horizontal(
